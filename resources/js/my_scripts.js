...
var anchors = [document.createElement("a"), document.createElement("a"), document.createElement("a") ,document.createElement("a")];
...
function viewStudentStats(id, toggle){
	console.log("viewStudentStates invoked with args: " + id + toggle);
	var my_el = document.getElementById(id);
	//console.log(my_el);
	if (toggle == 0){
		my_el.style.visibility = "hidden";
		my_el.style.height = "0";
	}
	else if (toggle == 1){
		my_el.style.visibility = "visible";
		my_el.style.height = "auto";
	}
}				
/*
	Home Page: 
...
//		anchors[index] = document.createElement("a");
//		anchors[index].href = "#";
//		anchors[index].onClick = "switchPlayers(" + index + ");";
//		anchors[index].innerHTML = players[index].name;
//		console.log("Player " + anchors[index].innerHTML + " added with tag: " + anchors[index]);
		dropdown.innerHTML += ("<a href=\"#\" onclick=\"switchPlayers(" + index + ")\" class=\"dropdown-item\">" + players[index].name + "</a>");
...
function switchPlayers(playerNum){
	...
	//var fields = ["selectPlayerButton", "player_img", "p_year", "p_major", "g_played", "p_yards", "avg_p_yards", "r_yards", "avg_r_yards", "rec_yards", "avg_rec_yards"];
